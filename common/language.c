...
const char* const g_strings[StrId_Max][17] =
{
    ...
    [StrId_CouldNotOpenFile] =
    {
        ...
        STR_KO("파일을 열 수 없습니다:\n%s"),
        STR_RU("Не удалось открыть файл:\n%s"),
        STR_ZH_HANS("无法打开文件:\n%s"),
        STR_ZH_HANT("無法開啟檔案:\n%s"),
    },
    ...
    [StrId_NroNotFound] =
    {
        ...
        STR_RU("Не найден исполняемый файл : %s"),
    },
    ...
    [StrId_NoAppsFound_Msg] =
    {
        ...
        STR_RU(
            ...
            "названием switch и она содержит NRO файлы."
        ),
        STR_ZH_HANS(
            "找不到任何自制程序(nro)。\n"
    ...
    [StrId_NetLoaderOffline] =
    {
        ...
        STR_RU("Автономный режим, ожидание подключения к сети…"),
    },
